...
import {MatButtonModule,  MatIconModule, MatTooltipModule, MatTabsModule, MatFormFieldModule, MatInputModule, MatListModule, MatBottomSheetModule, MatCardModule, MatExpansionModule, MatToolbarModule, MatTableModule, MatSliderModule, MatSlideToggleModule, MatSelectModule, MAT_SNACK_BAR_DEFAULT_OPTIONS, MatSnackBarModule, MatAutocompleteModule, MatDatepickerModule, MatDatepickerToggle, MatNativeDateModule, MAT_DATE_LOCALE, MatSpinner, MatProgressSpinner, MatProgressSpinnerModule, MatSidenavModule, MatGridListModule, MatPaginatorModule, MatCheckboxModule, MatMenuTrigger, MatMenuModule} from '@angular/material';
